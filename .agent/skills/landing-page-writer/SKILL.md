...
description: Write or improve conversion-focused landing pages for products, services, and offers with practical SEO and AEO structure. Use when the user asks for a landing page, product page, SEO landing page, or AEO landing page.
---
...
```json
{
  ...
  "keyword_data": "string — optional keyword-research output",
...
Meta Description: [draft only; hand off to meta-description-generator when available]
...
- Receives optional context from `keyword-research` and `content-cluster`.
- Hand off the completed page to `meta-description-generator`, `content-quality-auditor`, `internal-linking`, and `schema-generator` when available or requested.
